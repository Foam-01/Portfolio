          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <FaEnvelope className="h-4 w-4 mr-3 text-blue-400" />
                <a
              ...
              <div className="flex items-center">
                <FaMapMarkerAlt className="h-4 w-4 mr-3 text-blue-400" />
              ...
              {Object.entries(personalInfo.socialLinks).map(([platform, url]) => {
                ...
                return (
                  <a
                    ...
                    className="text-gray-400 hover:text-white active:text-blue-400 transition-colors duration-200 p-2 -m-2 touch-manipulation min-w-[44px] min-h-[44px] flex items-center justify-center"
