...
export const projects: Project[] = [
  ...
  description: 'A modern beauty salon landing page that showcases services, promotions, and customer reviews. Built with React Next, Tailwind CSS, and Vite to provide a clean UI and responsive experience for users.',
  technologies: ['React', 'Vite', 'Tailwind CSS', 'JavaScript', 'HTML', 'CSS','Next'],
  ...
  description: 'A web-based video downloader that supports multiple platforms such as YouTube and Facebook using yt-dlp as the core engine. Built with a Flask backend and an HTML/JavaScript frontend, featuring real-time download progress, concurrent downloads, and automatic saving to the user’s Downloads folder.',
  ...
  description: 'A Robotic Process Automation (RPA) tool that automates the YouTube video upload workflow. Built with Python and PyAutoGUI to simulate human interactions on YouTube Studio, enabling fast uploads, automatic configuration, and precise scheduling.',
  technologies: ['Python','PyAutoGUI','RPA','Windows Automation','YouTube Studio'],
